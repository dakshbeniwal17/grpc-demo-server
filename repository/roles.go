...
type Role struct {
	...
	IsOwner              null.Bool `boil:"is_owner" json:"is_owner,omitempty" toml:"is_owner" yaml:"is_owner,omitempty"`
	IsRenter             null.Bool `boil:"is_renter" json:"is_renter,omitempty" toml:"is_renter" yaml:"is_renter,omitempty"`
	MicroserviceConsumer null.Bool `boil:"microservice_consumer" json:"microservice_consumer,omitempty" toml:"microservice_consumer" yaml:"microservice_consumer,omitempty"`
	BatchConsumer        null.Bool `boil:"batch_consumer" json:"batch_consumer,omitempty" toml:"batch_consumer" yaml:"batch_consumer,omitempty"`
...
var RoleColumns = struct {
	...
	IsOwner:              "is_owner",
	IsRenter:             "is_renter",
	MicroserviceConsumer: "microservice_consumer",
	BatchConsumer:        "batch_consumer",
	UserID:               "user_id",
}
...
var RoleTableColumns = struct {
	...
	ID:                   "roles.id",
	IsOwner:              "roles.is_owner",
	IsRenter:             "roles.is_renter",
	MicroserviceConsumer: "roles.microservice_consumer",
	BatchConsumer:        "roles.batch_consumer",
...
var RoleWhere = struct {
	...
	IsOwner              whereHelpernull_Bool
	IsRenter             whereHelpernull_Bool
	MicroserviceConsumer whereHelpernull_Bool
	BatchConsumer        whereHelpernull_Bool
	UserID               whereHelperstring
}{
	ID:                   whereHelperstring{field: "\"roles\".\"id\""},
	IsOwner:              whereHelpernull_Bool{field: "\"roles\".\"is_owner\""},
	IsRenter:             whereHelpernull_Bool{field: "\"roles\".\"is_renter\""},
	MicroserviceConsumer: whereHelpernull_Bool{field: "\"roles\".\"microservice_consumer\""},
	BatchConsumer:        whereHelpernull_Bool{field: "\"roles\".\"batch_consumer\""},
	UserID:               whereHelperstring{field: "\"roles\".\"user_id\""},
}
...
var (
	roleAllColumns            = []string{"id", "is_owner", "is_renter", "microservice_consumer", "batch_consumer", "user_id"}
	roleColumnsWithoutDefault = []string{"user_id"}
	roleColumnsWithDefault    = []string{"id", "is_owner", "is_renter", "microservice_consumer", "batch_consumer"}
