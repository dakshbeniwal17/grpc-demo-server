...
type Request struct {
	...
	ExecutedAt null.Time    `boil:"executed_at" json:"executed_at,omitempty" toml:"executed_at" yaml:"executed_at,omitempty"`
...
var RequestTableColumns = struct {
	...
	CMD:        "requests.cmd",
	Time:       "requests.time",
	ExecutedAt: "requests.executed_at",
}
...
var RequestWhere = struct {
	...
	Time       whereHelpernull_Float64
	ExecutedAt whereHelpernull_Time
}{
	ID:         whereHelperstring{field: "\"requests\".\"id\""},
	UserID:     whereHelpernull_String{field: "\"requests\".\"user_id\""},
	CMD:        whereHelpernull_String{field: "\"requests\".\"cmd\""},
	Time:       whereHelpernull_Float64{field: "\"requests\".\"time\""},
	ExecutedAt: whereHelpernull_Time{field: "\"requests\".\"executed_at\""},
}
...
var (
	requestAllColumns            = []string{"id", "user_id", "cmd", "time", "executed_at"}
	requestColumnsWithoutDefault = []string{}
	requestColumnsWithDefault    = []string{"id", "user_id", "cmd", "time", "executed_at"}
...
func (o *Request) User(mods ...qm.QueryMod) userQuery {
...
func (requestL) LoadUser(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRequest interface{}, mods queries.Applicator) error {
	var slice []*Request
	var object *Request
...
// SetUser of the request to the related item.
// Sets o.R.User to related.
// Adds o to related.R.Requests.
func (o *Request) SetUser(ctx context.Context, exec boil.ContextExecutor, insert bool, related *User) error {
	var err error
	if insert {
...
func (o *Request) RemoveUser(ctx context.Context, exec boil.ContextExecutor, related *User) error {
	var err error
