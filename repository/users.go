...
type User struct {
	...
	Paying   null.Bool `boil:"paying" json:"paying,omitempty" toml:"paying" yaml:"paying,omitempty"`
...
var UserWhere = struct {
	...
	Paying   whereHelpernull_Bool
}{
	ID:       whereHelperstring{field: "\"users\".\"id\""},
	User:     whereHelperstring{field: "\"users\".\"user\""},
	Password: whereHelperstring{field: "\"users\".\"password\""},
	Valid:    whereHelpernull_Bool{field: "\"users\".\"valid\""},
	Expires:  whereHelpertime_Time{field: "\"users\".\"expires\""},
	Paying:   whereHelpernull_Bool{field: "\"users\".\"paying\""},
}
...
var (
	userAllColumns            = []string{"id", "user", "password", "valid", "expires", "paying"}
	userColumnsWithoutDefault = []string{"user", "password"}
	userColumnsWithDefault    = []string{"id", "valid", "expires", "paying"}
...
func (o *User) Requests(mods ...qm.QueryMod) requestQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"requests\".\"user_id\"=?", o.ID),
	)
...
func (userL) LoadRequests(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	var slice []*User
	var object *User
	...
	query := NewQuery(
		qm.From(`requests`),
		qm.WhereIn(`requests.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (userL) LoadRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`roles`),
		qm.WhereIn(`roles.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *User) AddRequests(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Request) error {
	var err error
...
// Sets o.R.User's Requests accordingly.
// Replaces o.R.Requests with related.
// Sets related.R.User's Requests accordingly.
func (o *User) SetRequests(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*Request) error {
	query := "update \"requests\" set \"user_id\" = null where \"user_id\" = $1"
...
// Sets related.R.User.
func (o *User) RemoveRequests(ctx context.Context, exec boil.ContextExecutor, related ...*Request) error {
	if len(related) == 0 {
		return nil
	}
