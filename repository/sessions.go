...
var SessionWhere = struct {
	...
	Valid:   whereHelpernull_Bool{field: "\"sessions\".\"valid\""},
	Expires: whereHelpertime_Time{field: "\"sessions\".\"expires\""},
	Time:    whereHelpernull_Float64{field: "\"sessions\".\"time\""},
}
...
var (
	sessionAllColumns            = []string{"id", "user_id", "valid", "expires", "time"}
	sessionColumnsWithoutDefault = []string{"user_id"}
	sessionColumnsWithDefault    = []string{"id", "valid", "expires", "time"}
