...
func (c *helloWorldClient) GetMessage(ctx context.Context, in *GetMessageRequest, opts ...grpc.CallOption) (*GetMessageResponse, error) {
	out := new(GetMessageResponse)
	err := c.cc.Invoke(ctx, "/hello_world.HelloWorld/GetMessage", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedHelloWorldServer) GetMessage(context.Context, *GetMessageRequest) (*GetMessageResponse, error) {
...
func _HelloWorld_GetMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HelloWorldServer).GetMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/hello_world.HelloWorld/GetMessage",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HelloWorldServer).GetMessage(ctx, req.(*GetMessageRequest))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _HelloWorld_GetMessage_Handler,
		},
	},
